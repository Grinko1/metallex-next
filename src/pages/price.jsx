...
import styleC from '../styles/Contacts.module.css'
    ...
    return (
        ...
        <div className={style.price}>
            ...
            <div className={style.container}>
                ...
                <Image className={style.exampleImg} src="/img/9.jpeg" alt="Любые сварочные работы Краснодарский край и Адыгея" width={200} height={200}/>
                </div>
